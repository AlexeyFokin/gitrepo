#line 1 "/home/alexey/dev/pico/arduino-pico/pio/squarewave/PIOMaxSqaureWave.pio.h"
// -------------------------------------------------- //
...
#define PIOMaxSqaureWave_wrap_target 1
#define PIOMaxSqaureWave_wrap 2

static const uint16_t PIOMaxSqaureWave_program_instructions[] = {
...
#if !PICO_NO_HARDWARE
static const struct pio_program PIOMaxSqaureWave_program = {
    .instructions = PIOMaxSqaureWave_program_instructions,
    .length = 3,
    .origin = -1,
};

static inline pio_sm_config PIOMaxSqaureWave_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + PIOMaxSqaureWave_wrap_target, offset + PIOMaxSqaureWave_wrap);
    return c;
}
