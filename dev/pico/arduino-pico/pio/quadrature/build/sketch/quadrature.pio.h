#line 1 "/home/alexey/dev/pico/arduino-pico/pio/quadrature/quadrature.pio.h"
// -------------------------------------------------- //
...
static inline void quadratureB_program_init(PIO pio, uint sm, uint offset, uint a_pin, uint b_pin, float div) {
