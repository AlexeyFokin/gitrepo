...
void setup() {
  ...
  PORT->Group[PORTA].DIR.reg = 0xfffffffful;
  ...
  //PORT->Group[PORTA].PMUX[22/2].reg = PORT_PMUX_PMUXE_H;
...
void loop() {
  ...
  PORT->Group[PORTA].OUT.reg = 0xfffffffful; 
  PORT->Group[PORTA].OUTCLR.reg = PORT_PA22;
  PORT->Group[PORTA].OUT.reg = 0x00000000ul;
